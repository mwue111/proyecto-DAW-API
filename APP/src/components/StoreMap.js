...
/**
 * StoreMap component.
 * Renders a Google Map with a marker at the specified address.
 * @param {object} props - The component props.
 * @param {string} props.address - The address to display on the map.
 * @param {string} props.apiKey - The API key for accessing Google Maps services.
 * @returns {JSX.Element} The rendered StoreMap component.
 */
const StoreMap = ({ address, apiKey }) => {
    ...
    /**
     * Callback function called when the Google Map is loaded.
